...
IMAGETAG=$1
[ -n "$1" ] || { echo "Missing IMAGETAG param" ; echo -e $USAGE ; exit 1 ;}
shift 1
SRCDIR=$1
[[ -n "$1" && -d $1 && -r $1 && -x $1 && -w $1 ]] || { echo "Missing SRCDIR or wrong permissions - must be an rwx directory" ; echo -e $USAGE ; exit 1 ;}
shift 1
